...
public class Lesson06Controller {
	...
	public String ex01_addUserView() {
...
//	}
	...
	public Map<String,Boolean> isDuplication(@RequestParam("name") String name) {
		...
		result.put("isDuplication", userBO.existUserByName(name));	//true면 중복
